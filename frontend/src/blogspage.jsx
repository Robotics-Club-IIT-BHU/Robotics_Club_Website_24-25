        ...
        <div className="bg-black text-white">
            <header className="flex items-center p-4">
                ...
                <nav className="flex-grow flex justify-around ml-4">
                    <a href="#" className="hover:bg-gray-700 p-2">Home</a>
                    <a href="#" className="hover:bg-gray-700 p-2">Events</a>
                    <a href="#" className="hover:bg-gray-700 p-2">Achievements</a>
                    <a href="#" className="hover:bg-gray-700 p-2">Blogs</a>
                    <a href="#" className="hover:bg-gray-700 p-2">About Us</a>
            ...
            <main>
                ...
                <div className="mx-20 text-white">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque eget turpis eu felis consequa Lorem, ipsum dolor sit amet consectetur adipisicing elit. At soluta, expedita non aliquid temporibus nulla? Eveniet porro, voluptate iure itaque culpa beatae quia!</p>
                </div>

                <div className="flex justify-center bg-white h-80 w-11/12 max-w-6xl mx-auto my-10 rounded-lg"></div>

                <div className="mx-20 text-white">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque eget turpis eu felis consequat fringilla Lorem, ipsum dolor sit amet consectetur adipisicing elit. Reiciendis nulla illo esse voluptates. Unde, consequatur! Id, dolorum. Possimus enim inventore ducimus incidunt voluptas, eveniet ea at, molestias hic ex distinctio sequi voluptatem debitis excepturi.</p>
                </div>

                <div className="mx-20 text-white">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque eget turpis eu felis consequat fringilla Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda, illum? Necessitatibus eaque itaque, nostrum ea eius quod voluptatem aliquid eligendi blanditiis accusantium explicabo, nulla similique aperiam, suscipit voluptate dolor ducimus. Nam sapiente voluptas labore quibusdam atque optio accusantium in doloremque!</p>
                </div>

                <br />

                <div className="mx-20 text-white">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque eget turpis eu felis consequat fringilla Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium incidunt odit nisi odio quis, omnis unde delectus pariatur beatae quam minima nesciunt eius nulla illo totam eos nihil reiciendis. Itaque, laboriosam deserunt!</p>
                </div>
